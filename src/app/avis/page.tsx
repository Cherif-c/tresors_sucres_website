...
export const metadata: Metadata = pageMetadata(
  '/avis',
  'Avis Google',
  'Laisser un avis Google sur Trésors Sucrés, pâtisserie algérienne artisanale à Montréal.',
);
      ...
      <section className="mx-auto max-w-7xl px-6 py-10 md:px-10 md:py-14">
        <div className="mb-8">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-tsCream/80 md:text-base">
            Votre avis aide de nouveaux clients à découvrir Trésors Sucrés et à mieux connaître notre
            univers.
          </p>
        </div>
